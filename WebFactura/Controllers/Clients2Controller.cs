...
namespace WebFactura.Controllers
{
    public class Clients2Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClientID,Name,LastName,Dni,Phone,Address")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClientID,Name,LastName,Dni,Phone,Address")] Client client)
        {
            if (ModelState.IsValid)
            {
